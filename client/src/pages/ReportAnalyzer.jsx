            ...
            <div className="relative h-[500px] bg-black/50 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden flex flex-col">
              ...
              <div className="p-6 bg-[#050505]">
                <button
                  ...
                  className="w-full relative overflow-hidden group/btn bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-800 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl transition-all"
                >
