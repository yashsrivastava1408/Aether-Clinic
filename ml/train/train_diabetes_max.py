...
from ml.modeling.preprocessors import ArrayToDataFrameTransformer, ZeroAsMissingTransformer
    ...
    return {
        "logistic_regression": Pipeline(
            steps=[
                ...
                ("zero_as_missing", ZeroAsMissingTransformer(ZERO_AS_MISSING)),
...
def main():
    print("\n" + "=" * 72)
    print("Diabetes training with calibration, threshold tuning, and versioning")
    print("=" * 72)

    df = pd.read_csv(ML_DIR / "datasets" / "diabetes_clean.csv")
    ...
    artifact_info = save_model_bundle(
        ...
        summary={
            ...
            "training_strategy": {
                "candidate_cv": "RepeatedStratifiedKFold(n_splits=5, n_repeats=6, random_state=42)",
